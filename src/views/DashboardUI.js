            ...
            <div class='dashboard-content'>
                <div class='bills-feed'>
                    <div class='status-bills-header'>
                        ...
                        <span class='arrow-icon-closed' id='arrow-icon1' data-testid='arrow-icon1'>${ArrowIcon}</span>
                    </div>
                    ...
                    <div class='status-bills-header' style='margin-top: 20px;'>
                        ...
                        <span class='arrow-icon-closed' id='arrow-icon2' data-testid='arrow-icon2'>${ArrowIcon}</span>
                    </div>
                    <div class='status-bills-container' id='status-bills-container2'></div>

                    <div class='status-bills-header' style='margin-top: 20px;'>
                        <h3> Refusé (${filteredBills(data && data.bills, "refused").length}) </h3>
                        <span class='arrow-icon-closed' id='arrow-icon3' data-testid='arrow-icon3'>${ArrowIcon}</span>
                    </div>
